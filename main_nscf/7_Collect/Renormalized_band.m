...
%KP=cell(5,1);
% X-R
KP{1}=[linspace(0.5,0.5,5).',linspace(0.0,0.5,5).',linspace(0.0,0.5,5).'];

% R-M
KP{2}=[linspace(0.5,0.5,5).',linspace(0.5,0.5,5).',linspace(0.5,0,5).'];
KP{2}=KP{2}(2:end,:);

% M-G
KP{3}=[linspace(0.5,0,5).',linspace(0.5,0,5).',linspace(0,0,5).'];
KP{3}=KP{3}(2:end,:);
...
% G-R
KP{4}=[linspace(0,0.5,5).',linspace(0,0.5,5).',linspace(0,0.5,5).'];
KP{4}=KP{4}(2:end,:);
%KP{4}=[linspace(0.5,0,16).',linspace(0.5,0,16).',linspace(0.5,0,16).'];
%KP{4}=KP{4}(9:end,:);

% % W-K
% KP{5}=[linspace(0.5,0.375,3).',linspace(0.25,0.375,3).',linspace(0.75,0.75,3).'];
% KP{5}=KP{5}(3:end,:);
nk=length(KP);
VKPT_Band=cell2mat(KP');
ll=zeros(nk,1);xl=cell(1,nk);
...
yline(0,':')
xticks(xt);
xticklabels({'X','R','M','\Gamma','R'})
for i=2:length(xt)
xline(xt(i),'LineWidth',1);
end
