function [QPROJ_ORI,FOVL_CORE,TRANS_CORE,TRANS_c_CORE]=...
...
FOVL_CORE=cell(1,NTYP);
TRANS_CORE=cell(1,NTYP);
TRANS_c_CORE=cell(1,NTYP);
for NT=1:NTYP
    FOVL_CORE{NT}=gather(QPROJ_ORI{NT}*CQIJ{NT}*QPROJ_ORI{NT}.');
    TRANS_c_CORE{NT}=gather(QPROJ_ORI{NT}*QPAW3{NT}*QPROJ_ORI{NT}.');
